...
import com.khokan.todo_list.models.Priority;
...
public class NewItem extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timeTextView = findViewById(R.id.etDisplayTime);
        dateTextView = findViewById(R.id.etDisplayDate);
        ImageView timeButton = findViewById(R.id.imgTime);
        ImageView dateButton = findViewById(R.id.imgDate);
