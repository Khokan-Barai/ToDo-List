package com.khokan.todo_list.adapter;
...
import com.khokan.todo_list.activities.MainActivity;
import com.khokan.todo_list.models.Item;
import com.khokan.todo_list.utils.Utils;
...
public class CustomItemsAdapter extends ArrayAdapter<Item> implements Filterable {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item != null) {
            ...
            TextView tvPriority =  v.findViewById(R.id.tvItemPriority);
            ...
            TextView dueDate = v.findViewById(R.id.tvDueDate);
